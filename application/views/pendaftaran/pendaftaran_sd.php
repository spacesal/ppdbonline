<div id="layoutSidenav_content">
     <main>
         <div class="container-fluid px-4"><br>
             <h1 class="mt-4">Data Pendaftaran SD</h1>
             <ol class="breadcrumb mb-4">
                 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalSd">
             ...
             <div class="card mb-4">
                 ...
                 <div class="card-body">
                     <table id="datatablesSimple">
                         ...
                         <tbody>
                             <?php
                                $data = $this->db->query("select * from pendaftaran_sd")->result_array();
                                $no = 1;
                                foreach ($data as $row) {
                                ?>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <a class="social-media-icon" href="<?= base_url('siswa/delete'); ?>"><span class="fas fa-pencil-square"></span></a>
                                         <a class="social-media-icon" href="<?= base_url('siswa/delete'); ?>"><span class="fas fa-trash"></span></a>
                                     </td>
                                 </tr>
                             <?php
                                    $no++;
             ...
             <!-- Modal -->
             <div class="modal fade" id="ModalSd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                 <div class="modal-dialog">
                     <div class="modal-content">
                         <div class="modal-header">
                             <h5 class="modal-title" id="staticBackdropLabel">Pendaftaran SD</h5>
                             <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                         </div>
                         <form action="<?= base_url('siswa/tambahdatasd'); ?>" method="post">
